          ...
          {name === 'Building' ? (
            ...
            name === 'product' ? (
              <div className='summaryparams' style={{flexWrap:'wrap',marginTop:'1 rem'}}>
                <div className='summaryparam'>
                  <p className='product_tab_title'>T shirt</p>
                  <p className='product_tab_value'>20000 units</p>
                  <p className='product_tab_value'>50000 KgCo<sub>2</sub>e</p>
                </div>
                <div className='summaryparam'>
                  <p className='product_tab_title'>Shirt</p>
                  <p className='product_tab_value'>20000 units</p>
                  <p className='product_tab_value'>50000 KgCo<sub>2</sub>e</p>
                </div>
                <div className='summaryparam'>
                  <p className='product_tab_title'>Jeans</p>
                  <p className='product_tab_value'>20000 units</p>
                  <p className='product_tab_value'>50000 KgCo<sub>2</sub>e</p>
                </div>
                <div className='summaryparam'>
                  <p className='product_tab_title'>Trousers</p>
                  <p className='product_tab_value'>20000 units</p>
                  <p className='product_tab_value'>50000 KgCo<sub>2</sub>e</p>
                </div>
                <div className='summaryparam'>
                  <p className='product_tab_title'>Shorts</p>
                  <p className='product_tab_value'>20000 units</p>
                  <p className='product_tab_value'>50000 KgCo<sub>2</sub>e</p>
                </div>
              </div>
